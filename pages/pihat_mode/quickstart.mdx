...
* Use [Raspberry Pi Imager](https://www.raspberrypi.com/software/) to image a microSD card
...
Select `Interface Options` and enable SPI, I2C, and Serial. Reboot the Raspberry Pi after making the changes.
